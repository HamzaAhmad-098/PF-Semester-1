...
main()
{
float movie_name , ticket_price1 , ticket_price2 , ticket_sold1 , ticket_sold2 , charity , total , remaining , donating;
...
cout<<"charity amount is":<<charity;
cout<<"remaining amount after charity is:"<<remaining;
